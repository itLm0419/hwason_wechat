    ...
    <section class="contentSpmple"  >
      ...
      <div id="bg">
              ...
              <div class="clearfix">
                ...
                <div class="fl">
                  <div class="customerPartMsg">
                    <span>张三</span>
                    <span>项目：CCVD+TM</span>
                    <span>业务员：张来信</span>
                  </div>
                  <div class="customerMsgId"><span>女 27</span>身份证号：41151*********7092</div>
                  <!--更多客户信息的展示-->
                  <div class="showDetailMsg">
                    <span>二维码：11111</span>
                    <span>接收人：王二</span>
                    <div>
                      <span>业务员电话：150******32</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="checkeBtns2 clearfix">
          <a href="javascript:;" class="fr">上一页</a>
