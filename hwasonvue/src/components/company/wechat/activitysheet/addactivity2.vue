     ...
     <form >
      <div class="contentBox">
        <ul class="modContent">
          <li class="clearfix">
            <div>体检套餐</div>
             <input type="text" placeholder="选择检测项目" name="item" style="" v-model:value="projects" readonly="true">
          </li>
          <li class="clearfix" v-on:click="setDate2">
            <div>活动时间</div>

            <div  class="actTime"  >{{date}}</div>
            <!--<input type="text" name="datetime" placeholder="请选择时间" v-on:focus="setDate2" v-model:value="date" >-->
          </li>
          <li class="clearfix">
            <div>活动地点</div>
          ...
          <li class="clearfix">
            <div>预计人数</div>
            <!--<validity ref="validity" field="peopleNum" v-model="num" :validators="['email']">-->
           <!-- <validity ref="validity" field="peopleNum" v-model="validation" :validators="{ required: true, minlength: 4 }">
              <input type="text" @input="$refs.validity.validate()">
            </validity>-->
            <!--<validity ref="validity" field="email"  :validators="['email']">
              <input type="text" @input="$refs.validity.validate()">
            </validity>-->
            <input type="text" name="peopleNum" v-model:value="estimated_number"  v-on:blur="ValidateNumeric" v-on:focus="ValidateNumeric2" >
...
<script>
 ...
 export default {
    ...
    mounted:function(){
     ...
     console.log("day_int:",this.day_init)
        console.log("day_int:",this.year_init)
        console.log("day_int:",this.month_init)
