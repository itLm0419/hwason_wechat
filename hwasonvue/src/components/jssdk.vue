<template>
  ...
  <div class="wxapi_container">
    ...
    <div class="lbox_close wxapi_form">
      ...
      <button class="btn btn_primary" id="scanQRCode1" @click="ScanCode">scanQRCode(直接返回结果)</button>
...
//    $.getJSON('/api/jssdk?url='+targetUrl,function(data){
//      init(data);
//    });
//  }();
  function init(data){
    ...
    console.log("signture",data.signature)
    wx.config({
      debug: true,
      appId: data.appid,
