        ...
        methods: {
            ...
            moveTo(cur){
              ...
              if(this.dType==='hour'){
                ...
                if(this.all.join().indexOf(cur+'时')===-1){
                  return false
                }
                if(cur==0) cur=24;
              }
              if(this.dType==='min'){
                ...
                if(this.all.join().indexOf(cur+'分')===-1){
                  return false
                }
                if(cur==30) cur = 2;
                else cur=1;
            ...
            all: {
                ...
                get:function(){
                    ...
                    if(this.dType =="year"&&vm.t.length==0){
                      ...
                      s = 1;
                      e = this.dayLength;
                      console.log("daylength:",this.dayLength)
                      vm.t = [];
                      vm.cNum = e - s + 1;
                      for (; s <= e; s++) {
                        vm.t.push(s + '日');
                      }
                    }else if(this.dType =="hour"){
                        s = 1;e = 24;
                        vm.t = [];
                        vm.cNum = e -s+1;
                        for( ;s<=e;s++){
