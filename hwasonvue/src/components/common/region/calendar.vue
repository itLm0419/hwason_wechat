<template>
    <div class="com-calendar"  >
        <div class="dp-container">
            ...
            <div class="dp-content dp-content2">
        ...
        methods:{
            ...
            listenToMyBoy(somedata){
              ...
              //  console.log("this.sDay1",this.sDay)
                ...
                {
                    this.curMonth=somedata.datadi;
                    this.curYear=somedata.datasheng;
                ...
                {
                    this.curDay=somedata.dataxian;
                    this.curMonth=somedata.datadi;
                 //   console.log("this.curDay2",this.curDay)
                    this.sMonth=this.curMonth;
                    this.sDay=this.curDay;
                }
            ...
            //    this.curDay = this.sDay
                console.log("this.curYear",this.sYear)
                console.log("this.curMonth",this.sMonth)
                console.log("this.curDay",this.sDay)
                this.onOk({
//                    year:vm.curYear||vm.year,
//                    month:vm.curMonth||vm.month,
//                    day:vm.curDay||vm.day,
                    year:vm.sYear||vm.year,
                    month:vm.sMonth||vm.month,
                    day:vm.sDay||vm.day,
